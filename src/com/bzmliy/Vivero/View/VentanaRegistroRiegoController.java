...
public class VentanaRegistroRiegoController {
	Main main;
	Conexion conn;
    @FXML private TableView<Tabla> tabla;
    @FXML private TableColumn<Tabla,String> id;
    @FXML private TableColumn<Tabla,String> nombre;
    @FXML private TableColumn<Tabla,String> tipo;
